...
INSERT INTO "public"."brands" ("id_brand", "name", "logo", "status") VALUES
(2, 'samsung', 'samsungnew-logo-220x48-1.png', 1);
INSERT INTO "public"."brands" ("id_brand", "name", "logo", "status") VALUES
(1, 'apple', 'logo-iphone-220x48.png', 1);
INSERT INTO "public"."brands" ("id_brand", "name", "logo", "status") VALUES
(3, 'xiaomi', 'logo-xiaomi-220x48-5.png', 1);
INSERT INTO "public"."brands" ("id_brand", "name", "logo", "status") VALUES
(4, 'oppo', 'OPPO42--logob_5.jpg', 1),
...
INSERT INTO "public"."products" ("id_product", "name", "sale_off", "views", "status", "id_brand", "created_at", "updated_at") VALUES
(37, 'OPPO Reno8 T 4G', 15, 200, 1, 4, '2024-07-11', '2024-07-11');
INSERT INTO "public"."products" ("id_product", "name", "sale_off", "views", "status", "id_brand", "created_at", "updated_at") VALUES
(38, 'OPPO Reno 12 F 5G', 0, 3000, 1, 4, '2024-07-11', '2024-07-11');
INSERT INTO "public"."products" ("id_product", "name", "sale_off", "views", "status", "id_brand", "created_at", "updated_at") VALUES
(1, 'iPhone 11 | Chính hãng VN/A', 10, 500, 1, 1, '2024-07-05', '2024-07-05');
INSERT INTO "public"."products" ("id_product", "name", "sale_off", "views", "status", "id_brand", "created_at", "updated_at") VALUES
(2, 'iPhone 12 mini | Chính hãng VN/A', 15, 200, 1, 1, '2024-07-06', '2024-07-06'),
...
INSERT INTO "public"."specification_category" ("id_specification_category", "id_product", "name") VALUES
(1, 1, 'Màn hình');
INSERT INTO "public"."specification_category" ("id_specification_category", "id_product", "name") VALUES
(2, 1, 'Camera sau');
INSERT INTO "public"."specification_category" ("id_specification_category", "id_product", "name") VALUES
...
INSERT INTO "public"."users" ("id_user", "name", "password", "email", "address", "phone", "image", "role", "created_at", "updated_at") VALUES
(3, 'hoàng thành thăng long', '$2b$10$llk644SqGj8Z7clL//hq9.tlbga.G4uvJXRsP1hV..rQg373EK8Dy', 'longh97@gmail.com', 'Thành phố Hồ Chí Minh', '0338015134', NULL, 0, '2024-07-12', '2024-07-12');
INSERT INTO "public"."users" ("id_user", "name", "password", "email", "address", "phone", "image", "role", "created_at", "updated_at") VALUES
(4, 'Huỳnh Tiến Long', '$2b$10$rsoSzMEeD4wTSWPOlwm1fOc4g28ju7Hnvu93F2C5D1YhKHBT/UDiO', 'huynhtienlong@gmail.com', '312321', '0338015137', NULL, 0, '2024-07-25', '2024-07-25');
INSERT INTO "public"."users" ("id_user", "name", "password", "email", "address", "phone", "image", "role", "created_at", "updated_at") VALUES
(5, 'Trương Tấn Vinh', '$2b$10$G6bkkYWFnAvxshuB8kUS/.5/.MN89rHnirRnvmNckT3pBDjCgv9cm', 'truongtanvinh@gmail.com', '312321', '0338015133', NULL, 0, '2024-07-25', '2024-07-25');
INSERT INTO "public"."users" ("id_user", "name", "password", "email", "address", "phone", "image", "role", "created_at", "updated_at") VALUES
(6, 'Json Server', '$2b$10$10BV6/PeIJh3n5z.onEZAOnEf/rx1QXMIXZM./EsFBKzZ39duWsMy', 'jsonserver@gmail.com', 'phường tân chánh hiệp', '0338312312', NULL, 0, '2024-07-25', '2024-07-25'),
(2, 'Nguyễn Admin', '$2b$10$llk644SqGj8Z7clL//hq9.tlbga.G4uvJXRsP1hV..rQg373EK8Dy', 'tienadmin@gmail.com', 'Thành phố Hồ Chí Minh', '0338015135', NULL, 1, '2024-07-12', '2024-07-12'),
(9, 'Nguyễn Văn Long', '$2b$10$llk644SqGj8Z7clL//hq9.tlbga.G4uvJXRsP1hV..rQg373EK8Dy', 'nvl@gmail.com', 'Thành phố Hồ Chí Minh', '0338157592', NULL, 0, '2024-08-04', '2024-08-04'),
(11, 'Nguyễn Văn A', '$2b$10$V5xbIHBzcS7lcUCcWOPW1O0Tdo6mOWisJxjU8TwDq8rrJns1INNCW', 'nguyenvana@gmail.com', 'Thành phố Hồ Chí Minh', '0338152321', NULL, 0, '2024-08-06', '2024-08-06'),
(12, 'Huỳnh Phước Long', '$2b$10$UE2ccCX4J12CEUHpa2D/f.DUj93rPWGxqhfM.i6.Ka/xUFrA1sKPi', 'huynhphuoclong@gmail.com', 'Công viên phần mềm Quang Trung', '0338015135', NULL, 0, '2024-08-06', '2024-08-06'),
(8, 'Nguyễn Tiến', '', 'ngamingyahoo@gmail.com', NULL, '0338157598', 'https://lh3.googleusercontent.com/a/ACg8ocJ43nfhc50KJuYe0_TIfsPhb9mDWeZMbEJtOA8GKqbOhgVl2mU6=s96-c', 1, '2024-07-26', '2024-07-26');


INSERT INTO "public"."deliveries" ("id_delivery", "name", "price", "speed", "status", "created_at", "updated_at") VALUES
(1, 'Vietnam Post', 10000, 'chậm', 1, '03:45:06.279085', '03:45:06.279085');
INSERT INTO "public"."deliveries" ("id_delivery", "name", "price", "speed", "status", "created_at", "updated_at") VALUES
(2, 'GrabExpress', 12000, 'trung bình', 1, '03:45:55.317131', '03:45:55.317131');
INSERT INTO "public"."deliveries" ("id_delivery", "name", "price", "speed", "status", "created_at", "updated_at") VALUES
(4, 'J&T Express', 20000, 'hơi nhanh 1', 1, '03:46:42.236083', '01:27:12.626874');
INSERT INTO "public"."deliveries" ("id_delivery", "name", "price", "speed", "status", "created_at", "updated_at") VALUES
(3, 'Ninja Van', 18000, 'nhanh ', 1, '03:46:42.236083', '01:27:17.154449'),
(8, 'test', 312312, 'test1321', 1, '01:52:58.432204', '01:53:03.695351');

INSERT INTO "public"."gallery" ("id_gallery", "url", "is_primary", "id_product") VALUES
(1, 'iphone-11.webp', 't', 1);
INSERT INTO "public"."gallery" ("id_gallery", "url", "is_primary", "id_product") VALUES
(2, 'iphone-12-mini_white.webp', 't', 2);
INSERT INTO "public"."gallery" ("id_gallery", "url", "is_primary", "id_product") VALUES
(3, '_0004_iphonexr-black-360_us-en-screen.webp', 't', 3);
INSERT INTO "public"."gallery" ("id_gallery", "url", "is_primary", "id_product") VALUES
(5, 'iphone13proxam1282_61_8_2_1_8.webp', 't', 4),
...
INSERT INTO "public"."options" ("id_option", "id_product", "color", "price", "quantity", "memory", "is_basic", "id_gallery") VALUES
(13, 12, 'Xanh lá', 25990000, 500, '8GB/128GB', 't', 13);
INSERT INTO "public"."options" ("id_option", "id_product", "color", "price", "quantity", "memory", "is_basic", "id_gallery") VALUES
(14, 13, 'Tím', 14890000, 500, '8GB/128GB', 't', 14);
INSERT INTO "public"."options" ("id_option", "id_product", "color", "price", "quantity", "memory", "is_basic", "id_gallery") VALUES
(15, 14, 'Tím', 22990000, 500, '8GB/256GB', 't', 15);
INSERT INTO "public"."options" ("id_option", "id_product", "color", "price", "quantity", "memory", "is_basic", "id_gallery") VALUES
(16, 15, 'Đen', 33990000, 500, '12GB/256GB', 't', 16),
...
INSERT INTO "public"."orders" ("id_order", "id_delivery", "id_user", "voucher_code", "email", "phone", "name", "address", "status", "origin_total", "total", "receiver_name", "receiver_address", "distance", "ship_fee", "created_at", "updated_at", "payment_method") VALUES
(16, 1, 12, '""', 'huynhphuoclong@gmail.com', '0338157592', 'Huỳnh Phước Long', 'Công viên phần mềm Quang Trung', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod');
INSERT INTO "public"."orders" ("id_order", "id_delivery", "id_user", "voucher_code", "email", "phone", "name", "address", "status", "origin_total", "total", "receiver_name", "receiver_address", "distance", "ship_fee", "created_at", "updated_at", "payment_method") VALUES
(15, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod');
INSERT INTO "public"."orders" ("id_order", "id_delivery", "id_user", "voucher_code", "email", "phone", "name", "address", "status", "origin_total", "total", "receiver_name", "receiver_address", "distance", "ship_fee", "created_at", "updated_at", "payment_method") VALUES
(14, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod');
INSERT INTO "public"."orders" ("id_order", "id_delivery", "id_user", "voucher_code", "email", "phone", "name", "address", "status", "origin_total", "total", "receiver_name", "receiver_address", "distance", "ship_fee", "created_at", "updated_at", "payment_method") VALUES
(11, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(9, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(4, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(2, 2, 9, '""', 'nvl@gmail.com', '0338157592', 'Nguyễn Văn Long', 'Thành phố Hồ Chí Minh', 0, 10791000, 10911000, 'Công Tôn Toản', 'Bình Thạnh, TP.Hồ Chí Minh', 10, 120000, '2024-08-05', '2024-08-05', 'cod'),
(1, 2, 8, '""', 'ngamingyahoo@gmail.com', '0338157598', 'Nguyễn Tiến', 'Thành phố Hồ Chí Minh', 0, 12533000, 12653000, 'Hoàng Long', 'Công viên phần mềm Quang Trung', 10, 120000, '2024-08-05', '2024-08-05', 'cod'),
(5, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(6, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(7, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(8, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(12, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(10, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(13, 1, 11, '""', 'nguyenvana@gmail.com', '0338152321', 'Nguyễn Văn A', 'Thành phố Hồ Chí Minh', 0, 21582000, 20602000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(17, 1, 3, '""', 'longh97@gmail.com', '0338015134', 'hoàng thành thăng long', 'Thành phố Hồ Chí Minh', 0, 11672700, 11189000, NULL, NULL, 10, 100000, '2024-08-06', '2024-08-06', 'cod'),
(18, 2, 8, '""', 'ngamingyahoo@gmail.com', '0338157598', 'Nguyễn Tiến', 'Thành phố Hồ Chí Minh', 0, 17910000, 17134000, NULL, NULL, 10, 120000, '2024-08-07', '2024-08-07', 'cod');


INSERT INTO "public"."order_details" ("id_order_detail", "id_order", "id_product", "origin_price", "sale_price", "memory", "color", "quantity") VALUES
(1, 1, 46, 5490000, 4941000, '8GB/256GB', 'Trắng', 1);
INSERT INTO "public"."order_details" ("id_order_detail", "id_order", "id_product", "origin_price", "sale_price", "memory", "color", "quantity") VALUES
(2, 1, 26, 9490000, 7592000, '8GB/256GB', 'Xanh dương', 1);
INSERT INTO "public"."order_details" ("id_order_detail", "id_order", "id_product", "origin_price", "sale_price", "memory", "color", "quantity") VALUES
(3, 2, 1, 11990000, 10791000, '4GB/64GB', 'Trắng', 1);
INSERT INTO "public"."order_details" ("id_order_detail", "id_order", "id_product", "origin_price", "sale_price", "memory", "color", "quantity") VALUES
(5, 4, 1, 11990000, 10791000, '4GB/64GB', 'Trắng', 2),
...
INSERT INTO "public"."product_details" ("id_product_detail", "id_specification_category", "name", "value") VALUES
(15, 5, 'Công nghệ NFC', 'Có');
INSERT INTO "public"."product_details" ("id_product_detail", "id_specification_category", "name", "value") VALUES
(16, 5, 'Thẻ SIM', 'Nano-SIM + eSIM');
INSERT INTO "public"."product_details" ("id_product_detail", "id_specification_category", "name", "value") VALUES
(17, 5, 'Hệ điều hành', 'iOS 13 hoặc cao hơn (Tùy vào phiên bản phát hành)');
INSERT INTO "public"."product_details" ("id_product_detail", "id_specification_category", "name", "value") VALUES
(18, 5, 'Hồng ngoại', 'Không'),
...
INSERT INTO "public"."reviews" ("id_review", "id_user", "id_product", "content", "created_at", "updated_at") VALUES
(1, 2, 1, 'Sản phẩm này thật sự rất tuyệt đấy !', '2024-07-12', '2024-07-12');
INSERT INTO "public"."reviews" ("id_review", "id_user", "id_product", "content", "created_at", "updated_at") VALUES
(2, 8, 1, 'Tôi rất thich sản phẩm này cũng như chất lượng dịch vụ tuyệt vời của Stech, các bạn nên mua nha.', '2024-08-04', '2024-08-04');
INSERT INTO "public"."reviews" ("id_review", "id_user", "id_reply", "id_product", "content", "created_at", "updated_at") VALUES
(3, 8, 1, 1, 'Tôi rất thich sản phẩm này cũng như chất lượng dịch vụ tuyệt vời của Stech, các bạn nên mua nha.', '2024-08-04', '2024-08-04');


INSERT INTO "public"."shop" ("id_shop", "name", "address", "phone", "status", "email") VALUES
(1, 'Stech', 'Công viên phần mềm Quang Trung, Tân Chánh Hiệp, Quận 12, thành phố Hồ Chí Minh', '0338015138', 1, 'stechsupport@gmail.com');


INSERT INTO "public"."vouchers" ("id_voucher", "code", "discount", "max_discount", "min_amount", "is_percent", "expired", "end_date", "created_at", "updated_at") VALUES
(1, 'sale5', 5, 2000000, 10000000, 't', 'f', '2024-08-30', '2024-07-15', '2024-07-15');
INSERT INTO "public"."vouchers" ("id_voucher", "code", "discount", "max_discount", "min_amount", "is_percent", "expired", "end_date", "created_at", "updated_at") VALUES
(2, 'sale10', 10, 5000000, 15000000, 't', 'f', '2024-08-30', '2024-08-03', '2024-08-03');
